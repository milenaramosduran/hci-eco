    ...
    <section ref={containerRef} className="py-[10vh] px-6 md:px-12 max-w-[1600px] mx-auto bg-[#FDFDF9]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
        <div className="lg:col-span-7">
          <h2 className="intro-title text-3xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-[1.1] mb-12 font-display will-change-transform">
        ...
        <div className="lg:col-span-5 lg:mt-4">
          <p className="intro-desc text-base md:text-lg text-gray-600 leading-relaxed mb-16 font-light will-change-transform">
